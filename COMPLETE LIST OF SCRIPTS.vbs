...
script_array(script_num).description		= "Pulls ABAWD Tracking Record and output of MONY/INQX into spreadsheet for comparison."
script_array(script_num).category               = "ACTIONS"
script_array(script_num).workflows              = ""
script_array(script_num).subcategory            = array("ABAWD")
script_array(script_num).release_date           = #09/25/2019#
...
ReDim Preserve script_array(script_num)
Set script_array(script_num) = new script_bowie
script_array(script_num).script_name 			= "MA MSA GRH Fiater"																		'Script name
script_array(script_num).description 			= "FIATS MA method X budget to method B, adds income and assets for cases that received automatic MA under old policy."
script_array(script_num).category               = "ACTIONS"
script_array(script_num).workflows              = ""
script_array(script_num).subcategory            = array("")
script_array(script_num).release_date           = #01/07/2019#
