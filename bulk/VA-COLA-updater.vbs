...
'file_selection_path = "F:\Bulk Reports\VA COLA 2020.xlsx"
	     		...
	     		If income_type = panel_income_type then
                    ...
                    Else
                        ...
                        elseif prospective_amt = "0.00" THEN
                            ...
                            income_panel_found = false
												elseif prospective_amt = "61.00" THEN
		                        'msgbox "amount is 0. Not processing."
		                         UNEA_array(case_status, i) = "Error"
		                         UNEA_array(case_notes, i) = "Income is $61. Review case."	'Explanation for the rejected report'
		                         income_panel_found = false
                        Else
                            PF9
