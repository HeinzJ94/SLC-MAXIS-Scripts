...
name_of_script = "NOTICES - ABAWD E&T Voluntary WCOM.vbs"
start_time = timer
...
Msgbox "Select the SNAP ABAWD(s) in the household."
...
DO
	...
	If waiting_check = "Waiting" and prog_type = "FS" THEN 'checking program type and if it's been printed
	    ...
	    EMSetCursor 03, 15
    	CALL write_variable_in_SPEC_MEMO("Minnesota has changed the rules for time-limited SNAP recipients. " & client_name & " is(are) not required to participate in SNAP Employment and Training (SNAP E&T), but may choose to. Participation in SNAP E&T may extend your SNAP benefits and offer you support as you seek employment. Ask your worker about SNAP E&T.")
	    PF4
		PF3
...
ELSE 					'If a waiting FS notice is found
	script_end_procedure("Success! The WCOM has been added.")
END IF
